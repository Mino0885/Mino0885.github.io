$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是编写一些网站的后台代码</div>",2000);
	...
	w.load("<ul>");
	w.load("<li class='writecode'>mail:Mino0885@outlook.com</li>");
	w.load("<li class='writecode'>blog:<a href='https://mino0885.github.io/' target='_blank'>https://mino0885.github.io/</a></li>");
	w.load("</ul>");
	...
	w.load("<li class='writecode'>熟悉JavaWeb技术,可以熟练操作;Jsp,Servlet,Filter,Listener,Cookie,Session等注解与Xml开发,了解EL表达式,JSTL表达式</li>");
	w.load("<li class='writecode'>掌握JavaScript,Css,Ajax等网页编程</li>");
	...
	c.load("<div class='comment writecode'>&nbsp;*微信:PUKEFAN1</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:17610171911</div>");
